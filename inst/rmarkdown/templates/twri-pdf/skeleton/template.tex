...
\IfFontExistsTF{CrimsonPro-Regular}{
\setmainfont{CrimsonPro-Regular}[BoldFont={CrimsonPro-Bold},
ItalicFont={CrimsonPro-Italic},
BoldItalicFont={CrimsonPro-MediumItalic}]
}{
...
\IfFontExistsTF{OpenSans-Regular}{
\setsansfont{OpenSans-Regular}[BoldFont={OpenSans-Bold},
...
\hypersetup{breaklinks=true,
            ...
            pdftitle={$title-meta$},
            colorlinks=true,
            citecolor=$if(citecolor)$$citecolor$$else$twriblue$endif$,
            urlcolor=$if(urlcolor)$$urlcolor$$else$twriblue$endif$,
...
\begin{center}
\sffamily{\Huge\textcolor{twriblue}{$title$}}
